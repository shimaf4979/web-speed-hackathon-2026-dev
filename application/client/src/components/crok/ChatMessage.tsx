...
const CrokMarkdownMessage = lazy(async () =>
  import("@web-speed-hackathon-2026/client/src/components/crok/CrokMarkdownMessage").then(
    (module) => ({
      default: module.CrokMarkdownMessage,
    }),
  ),
);
