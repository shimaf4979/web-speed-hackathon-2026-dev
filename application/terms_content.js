export const TERMS_PAGE_TITLE = "利用規約 - CaX";

export const TERMS_ARTICLE_CLASS_NAME = "px-2 pb-16 leading-relaxed md:px-4 md:pt-2";

export const TERMS_ARTICLE_HTML = `
  <h1 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-3xl leading-[normal] font-bold">利用規約</h1>
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第1条（適用）</h2>
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第2条（利用登録）</h2>
  <ol class="list-decimal pl-8">
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第3条（ユーザーIDおよびパスワードの管理）</h2>
  <ol class="list-decimal pl-8">
    <li>ユーザーは、自己の責任において、本サービスのユーザーIDおよびパスワードを適切に管理するものとします。</li>
    <li>ユーザーは、いかなる場合にも、ユーザーIDおよびパスワードを第三者に譲渡または貸与し、もしくは第三者と共用することはできません。当社は、ユーザーIDとパスワードの組み合わせが登録情報と一致してサインインされた場合には、そのユーザーIDを登録しているユーザー自身による利用とみなします。</li>
    <li>ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害は、当社に故意又は重大な過失がある場合を除き、当社は一切の責任を負わないものとします。</li>
  </ol>

  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第4条（利用料金および支払方法）</h2>
  <ol class="list-decimal pl-8">
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第5条（禁止事項）</h2>
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第6条（本サービスの提供の停止等）</h2>
  <ol class="list-decimal pl-8">
    <li>
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第7条（著作権）</h2>
  <ol class="list-decimal pl-8">
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第8条（利用制限および登録抹消）</h2>
  <ol class="list-decimal pl-8">
    <li>
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第9条（退会）</h2>
  <p>ユーザーは、当社の定める退会手続により、本サービスから退会できるものとします。</p>

  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第10条（保証の否認および免責事項）</h2>
  <ol class="list-decimal pl-8">
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第11条（サービス内容の変更等）</h2>
  <p>当社は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。</p>

  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第12条（利用規約の変更）</h2>
  <p>当社は、必要と判断した場合には、ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお、本規約の変更後、本サービスの利用を開始した場合には、当該ユーザーは変更後の規約に同意したものとみなします。</p>

  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第13条（個人情報の取扱い）</h2>
  <p>当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>

  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第14条（通知または連絡）</h2>
  ...
  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第15条（権利義務の譲渡の禁止）</h2>
  <p>ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</p>

  <h2 class="mt-4 mb-2 font-[Rei_no_Are_Mincho] text-2xl leading-[normal] font-bold">第16条（準拠法・裁判管轄）</h2>
  <ol class="list-decimal pl-8">
